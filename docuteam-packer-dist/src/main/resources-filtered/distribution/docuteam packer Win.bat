...
start	javaw -Djava.library.path=lib -Dfile.encoding=utf-8 -Djava.util.logging.manager=org.apache.logging.log4j.jul.LogManager -Xms512M -Xmx2048M -cp config\;.\;docuteam-packer-${project.version}.jar ch.docuteam.packer.gui.launcher.LauncherView
