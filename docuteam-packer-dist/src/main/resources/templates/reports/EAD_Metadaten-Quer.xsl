	...
	<xsl:template match="/">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
			<fo:layout-master-set>
				<fo:simple-page-master master-name="Deckblatt" reference-orientation="90" margin-top="1.5cm" margin-bottom="1cm" margin-left="1.5cm" margin-right="1cm">
				...
				<fo:simple-page-master master-name="Folgeseite" reference-orientation="90" margin-top="1.5cm" margin-bottom="1cm" margin-left="1.5cm" margin-right="1cm">
					<fo:region-body region-name="body" margin-top="2cm" margin-bottom="1cm"/>
					<fo:region-before region-name="header" extent="2cm" />
					<fo:region-after region-name="footer" extent=".5cm" />
				</fo:simple-page-master>
