...
java	-Xms512M -Xmx2048M -Dfile.encoding=utf-8 -Djava.util.logging.manager=org.apache.logging.log4j.jul.LogManager -cp config/:./:${project.artifactId}-${project.version}.jar ch.docuteam.packer.gui.launcher.LauncherView &
