		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" font-family="Arial">
			...
			<fo:page-sequence master-reference="Bericht" id="report">
				...
				<fo:static-content flow-name="footer" font-size="8pt">
					...
					<fo:flow flow-name="body" font-size="10pt" page-break-before="always" font-family="Times">
						<xsl:choose>
							<xsl:when test="count((//EAD:archdesc | //EAD:c)[@otherlevel='Kassation']) > 0">
								<fo:block-container>
									<!-- TODO: translate attribute label -->
									
									<xsl:for-each select="(//EAD:archdesc | //EAD:c)[@otherlevel='Kassation']">
