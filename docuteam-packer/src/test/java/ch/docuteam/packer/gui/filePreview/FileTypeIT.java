...
public class FileTypeIT {
    ...
    public void getFileType_PDF() {       
        FileType fileType1 = FileType.getFileType("fmt/14");
        assertEquals(FileType.PDF, fileType1);
        //        
        FileType fileType2 = FileType.getFileType("application/pdf");
        assertEquals(FileType.PDF, fileType2);
        
        FileType fileType3 = FileType.getFileType("pdf");
        assertEquals(FileType.PDF, fileType3);        
    }
    
    @Test
    public void getFileType_OpenDocument_Presentation() {        
        FileType fileType1 = FileType.getFileType("fmt/138");
        assertEquals(FileType.OOConvertable, fileType1);
        //        
        FileType fileType2 = FileType.getFileType("application/vnd.oasis.opendocument.presentation");
        assertEquals(FileType.OOConvertable, fileType2);
        
        FileType fileType3 = FileType.getFileType("odp");
